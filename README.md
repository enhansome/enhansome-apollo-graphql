...
* [Apollo Client](https://github.com/apollographql/apollo-client) ⭐ 19,807 | 🐛 402 | 🌐 TypeScript | 📅 2026-08-19 - A fully-featured, production ready caching GraphQL client for every server or UI framework.
* [GraphQL Server](https://github.com/apollographql/graphql-server) ⭐ 13,945 | 🐛 87 | 🌐 TypeScript | 📅 2026-08-17 - GraphQL server for Express, Connect, Hapi and Koa.
* [GraphQL Yoga](https://github.com/graphcool/graphql-yoga) ⭐ 8,528 | 🐛 159 | 🌐 TypeScript | 📅 2026-08-19 - Fully-featured GraphQL Server with focus on easy setup, performance & great developer experience.
* [GraphQL Tools](https://github.com/apollographql/graphql-tools) ⭐ 5,432 | 🐛 135 | 🌐 TypeScript | 📅 2026-08-18 - Build and mock your GraphQL.js schema using the schema language.
...
* [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 141,864 | 🐛 4,088 | 🌐 JavaScript | 📅 2026-08-19 - Boilerplate for building Next.js apps with Apollo.
