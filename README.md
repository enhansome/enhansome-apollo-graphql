...
* [Apollo Client](https://github.com/apollographql/apollo-client) ⭐ 19,810 | 🐛 404 | 🌐 TypeScript | 📅 2026-08-15 - A fully-featured, production ready caching GraphQL client for every server or UI framework.
...
* [GraphQL Yoga](https://github.com/graphcool/graphql-yoga) ⭐ 8,531 | 🐛 161 | 🌐 TypeScript | 📅 2026-08-14 - Fully-featured GraphQL Server with focus on easy setup, performance & great developer experience.
...
* [Apollo Client Devtools](https://github.com/apollographql/apollo-client-devtools) ⭐ 1,528 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-15 - GraphQL debugging tools for Apollo Client in the Chrome developer console.
...
* [Next.js With Apollo](https://github.com/zeit/next.js/tree/master/examples/with-apollo) ⭐ 141,796 | 🐛 4,207 | 🌐 JavaScript | 📅 2026-08-16 - Boilerplate for building Next.js apps with Apollo.
